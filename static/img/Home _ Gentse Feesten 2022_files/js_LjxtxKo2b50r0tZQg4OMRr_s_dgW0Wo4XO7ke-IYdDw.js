"use strict";var Slideshow=function(s){var e=null,i=null,o=null;!function(s){if(s){var n,t,l=(e=s).querySelector(".item-list ul");if(l)if(i=l.children,o=i.length,i)n='<div class="slideshow-buttons"><button class="slideshow-buttons-prev"><span class="visually-hidden">Previous</span></button><button class="slideshow-buttons-next"><span class="visually-hidden">Next</span></button><span class="slideshow-buttons-counter"><span class="slideshow-current">1</span>/<span class="slideshow-total">'+o+"</span></span></div>",(t=e.querySelector(".view-content")).innerHTML=t.innerHTML+n,e.querySelector(".slideshow-buttons")}}(s)};;
"use strict";!function(f){Drupal.behaviors.gfThemeSlideshow={attach:function(e,i){for(var n=document.querySelectorAll(".view-eyecatchers"),s=0;s<n.length;s++){new Slideshow(n[s]);var t=f(n[s]),o=t.find(".slides").eq(0),c=t.find(".slideshow-buttons-prev").eq(0),r=t.find(".slideshow-buttons-next").eq(0),l=t.find(".slideshow-current").eq(0);o.slick({arrows:!1,dots:!1,infinite:!0,slidesToShow:2,responsive:[{breakpoint:768,settings:{slidesToShow:1}}]}),d(o,c,r,l)}function d(e,i,n,t){e.on("init reInit afterChange",function(e,i,n){var s=(n||0)+1;t.text(s)}),i.click(function(){e.slick("slickPrev")}),n.click(function(){e.slick("slickNext")})}}}}(jQuery);;
/**
...
"use strict";!function(e,s){s.behaviors.gfThemePopularEvents={attach:function(t,l){e(".popular-events--homepage .item-list ul").slick({infinite:!1,slidesToShow:2.3,prevArrow:'<button type="button" class="slick-prev"><svg id="arrow-animation-left--popular-events" viewBox="0 0 1197 269" aria-hidden="true">\n      <path d="M-0.159,111.093l639.756,0l-85.15,-76.855l29.643,-32.816l144.777,131.216l-143.608,129.655l-30.23,-32.081l84.144,-76.315l-639.756,0l0.424,-42.804Z" fill="#fff"></path>\n    </svg><span class="visually-hidden">'+s.t("Previous")+"</span></button>",nextArrow:'<button type="button" class="slick-next"><svg id="arrow-animation-right--popular-events" viewBox="0 0 1197 269" aria-hidden="true">\n      <path d="M-0.159,111.093l639.756,0l-85.15,-76.855l29.643,-32.816l144.777,131.216l-143.608,129.655l-30.23,-32.081l84.144,-76.315l-639.756,0l0.424,-42.804Z" fill="#fff"></path>\n    </svg><span class="visually-hidden">'+s.t("Next")+"</span></button>",responsive:[{breakpoint:768,settings:{slidesToShow:1.3}}]})}}}(jQuery,Drupal);;
